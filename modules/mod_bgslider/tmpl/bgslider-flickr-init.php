...
/*global $:false */
/*global window: false */
$flickr_api_key = $params->get('flickr_api_key');
$flickr_photoset_id = $params->get('flickr_photoset_id');
?>
<script>
(function(){
  "use strict";
...
$(function ($) {
     ...
     //USE YOUR OWN FLICKR API KEY
            ...
            $.mbFlickr.flickr_api_key="<?php echo $flickr_api_key; ?>"; //this is my Flickr API key. Create your own
            $.mbFlickr.defaults.size="surce"; //  medium / surce
            $.mbFlickr.defaults.per_page=100;
            $.mbFlickr.defaults.flickr_photoset_id='<?php echo $flickr_photoset_id; ?>';
