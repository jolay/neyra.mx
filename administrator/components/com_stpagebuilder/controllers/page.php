...
{
	public function getModel($name = 'Page', $prefix = 'StpagebuilderModel', $config = array('ignore_request' => true))
	{
	...
	public function duplicate(){
		...
		$this->setRedirect('index.php?option=com_stpagebuilder');
		return true;
	}

	public function add(){
		$this->setRedirect('index.php?option=com_stpagebuilder&view=page');
		return true;
	}
	public function demo(){
		$model = $this->getModel();
		$id = $model->addNewPage(JRequest::getVar('pagename'));
		$this->setRedirect('index.php?option=com_stpagebuilder&view=page&layout=edit&id='.$id);
		return true;
	}
	...
	public function delete(){
		$model = $this->getModel();
		$model->stdelete();
		$this->setRedirect('index.php?option=com_stpagebuilder','Delete success');
		return true;
	}
}
