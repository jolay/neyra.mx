...
<div class="st-design row-fluid">
	<div class="span2 st-items">
		<div class="st-title-layout"><strong><?php echo JText::_('COM_STPAGEBUILDER_TOOLBAR'); ?></strong></div>
...
<div class="namepage none">
	<div class="st-namepage form-horizontal">
		<div class="control-group">
		    <label class="control-label" for="inputNamepage"><?php echo JText::_('COM_STPAGEBUILDER_INPUTNAME'); ?>:</label>
		    <div class="controls">
				<input type="text" id="inputNamepage" placeholder="<?php echo JText::_('COM_STPAGEBUILDER_INPUTNAME'); ?>"
		...
		<div class="row-fluid">
			<div id="page-fullwidth" class="st-radio">
				<label class="radio inline">
					<input type="radio" name="page-fullwidth" value="1" <?php echo ($this->configpage->fullwidth=='1')?'checked="checked"':"" ; ?>>Yes
				</label>
				<label class="radio inline">
					<input type="radio" name="page-fullwidth" value="0" <?php echo ($this->configpage->fullwidth=='0')?'checked="checked"':"" ; ?>>No
				</label>
			</div>
		</div>
