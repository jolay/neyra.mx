 ...
 * ------------------------------------------------------------------------
 * Copyright (C) 2013 ShineTheme Co., Ltd. All Rights Reserved.
 * @license - GNU/GPL, http://www.gnu.org/licenses/gpl.html
 * Author: ShineTheme Co., Ltd
 * Author Email: ducphamtien@gmail.com
...
<link rel="stylesheet" href="<?php echo $base_url;?>/plugins/system/shinetheme/assets/style.css" type="text/css" />
<script type="text/javascript" src="<?php echo $base_url;?>/media/system/js/mootools-core.js"></script>

<title>ShineTheme Typography style</title>
</head>
<body>
<?php
