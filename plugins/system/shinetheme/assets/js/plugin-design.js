...
function getPortfolioOption(data){
	...
	content+="<div class='st-nav-option st-portfolio'>";
        ...
        content+='<input type="text" name="st-title" value="'+((data.attr.title==null)?"Portfolio":data.attr.title)+'">';
        content+="<label>Description:</label>";
        content+='<textarea name="st-description" rows="4" cols="80">'+ ((data.attr.description==null?"":data.attr.description))+'';
        content+="</textarea>";
		content+="<div class='st-button-group'>";
		content+="<button class='btn btn-primary btn-save'>Save</button>";
		content+="<button class='btn btn-cancel'>Cancel</button>";
...
function saveHtml(){
    var title = jQuery('.st-navigation .html-title').val();
...
function getServicesOption(data){
    ...
    content+='<div class="row-fluid"><select name="st-template" class="st-template span6">';
    content+='<option value="services">Services</option>';
    content+='<option value="team">Team</option>';
    content+='</select></div>';
    content+="</div>";
    content+="<div class='st-button-group'>";
    content+="<button class='btn btn-primary btn-save'>Save</button>";
